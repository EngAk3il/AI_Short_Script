...
> Generated: 2026-05-15T18:59:31.349690+00:00
...
| **Output script** | `/Users/testgrid/Documents/Scripts/AI_Short_Script/scripts/NehaGupta/kerala_sacred_oath_astrology_politics_dna.md` |
| **Voice** | Hindi heritage/spiritual/identity content. Covers Indian temples, culture, national pride, Indian CEOs, spiritual tourism. Devotional reverent tone. 'Garv hai mujhe', 'Hamari sanskriti', 'Comment mein [X] zarur likhein'. Short fact-based scripts with patriotic emotional close. |
...
1. **`creator_pattern/NehaGupta/CREATOR_MIND.md`** — adopt mindset, tone, emotional arc (THIS IS YOUR BRAIN).
...
4. `patterns/NehaGupta/dna.md` if present — extra voice evidence.
4. Read 2–3 full `data/NehaGupta/<video_id>/transcript.txt` files (best match to topic) — absorb rhythm and vocabulary.
...
- [ ] Run: `python3 validate_script.py "/Users/testgrid/Documents/Scripts/AI_Short_Script/scripts/NehaGupta/kerala_sacred_oath_astrology_politics_dna.md" -c NehaGupta` and fix failures
...
Per-transcript library: `creator_pattern/NehaGupta/deep_hooks.md` (22687 chars)
...
## Output format (write to `/Users/testgrid/Documents/Scripts/AI_Short_Script/scripts/NehaGupta/kerala_sacred_oath_astrology_politics_dna.md`)
...
## After you finish
1. Save the complete script to: **`/Users/testgrid/Documents/Scripts/AI_Short_Script/scripts/NehaGupta/kerala_sacred_oath_astrology_politics_dna.md`**
2. Delete any "Pending generation" placeholder text.
3. Optional check: `python3 validate_script.py "/Users/testgrid/Documents/Scripts/AI_Short_Script/scripts/NehaGupta/kerala_sacred_oath_astrology_politics_dna.md" -c NehaGupta`
