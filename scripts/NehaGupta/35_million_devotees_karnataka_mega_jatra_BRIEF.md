...
> Generated: 2026-05-15T19:14:42.779578+00:00
...
| **Context file (ONLY voice source)** | `/Users/testgrid/Documents/Scripts/AI_Short_Script/scripts/NehaGupta/35_million_devotees_karnataka_mega_jatra_context.md` |
...
1. **`35_million_devotees_karnataka_mega_jatra_context.md`** — CREATOR_MIND, cheatsheet, DNA, hooks, transcripts, format, rules (everything)
...
If voice guidance is missing from the context file, run `python3 prepare.py -c NehaGupta -t "3.5 Million Devotees Karnataka Mega Jatra"` to rebuild it.
...
1. Read **`35_million_devotees_karnataka_mega_jatra_context.md`** top to bottom once.
...
- [ ] Run: `python3 validate_script.py "/Users/testgrid/Documents/Scripts/AI_Short_Script/scripts/NehaGupta/35_million_devotees_karnataka_mega_jatra_dna.md" -c NehaGupta`

---

## After you finish
1. Save full script to: **`/Users/testgrid/Documents/Scripts/AI_Short_Script/scripts/NehaGupta/35_million_devotees_karnataka_mega_jatra_dna.md`**
